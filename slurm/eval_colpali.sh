...
#SBATCH --output=logs/eval_colpali_%j.log
#SBATCH --error=logs/eval_colpali_%j.err

# ColPali visual page retrieval evaluation.
# Pre-stage model weights on the login node first:
#   bash scripts/stage_retrieval_weights.sh
#
# Run: sbatch slurm/eval_colpali.sh
